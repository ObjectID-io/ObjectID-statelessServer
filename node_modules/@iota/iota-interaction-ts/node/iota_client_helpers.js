...
exports.WasmIotaTransactionBlockResponseWrapper = void 0;
exports.addGasDataToTransaction = addGasDataToTransaction;
exports.executeTransaction = executeTransaction;
exports.sleep = sleep;
const transactions_1 = require("@iota/iota-sdk/transactions");
const MINIMUM_BALANCE_FOR_COIN = BigInt(1000000000);
class WasmIotaTransactionBlockResponseWrapper {
...
exports.WasmIotaTransactionBlockResponseWrapper = WasmIotaTransactionBlockResponseWrapper;
 ...
 */
async function addGasDataToTransaction(iotaClient, senderAddress, txBcs, gasBudget) {
    const gasPrice = await iotaClient.getReferenceGasPrice();
    const gasCoin = await getCoinForTransaction(iotaClient, senderAddress);
    const txData = transactions_1.TransactionDataBuilder.fromBytes(txBcs);
    const gasData = {
...
async function executeTransaction(iotaClient, senderAddress, txBcs, signer, gasBudget) {
