...
import { Proposal, ProposalOutput, TransactionInternal, TransactionInternalOutput } from './index';
...
export class ApproveConfigChangeProposalTx {
  private constructor();
  free(): void;
  withGasBudget(budget: bigint): ApproveConfigChangeProposalTx;
  execute(client: IdentityClient): Promise<WasmTransactionInternalOutputVoid>;
  set gasBudget(value: bigint);
}
export class ApproveSendProposalTx {
  private constructor();
  free(): void;
  withGasBudget(budget: bigint): ApproveSendProposalTx;
  execute(client: IdentityClient): Promise<WasmTransactionInternalOutputVoid>;
  set gasBudget(value: bigint);
}
export class ApproveUpdateDidDocumentProposalTx {
  private constructor();
  free(): void;
  withGasBudget(budget: bigint): ApproveUpdateDidDocumentProposalTx;
  execute(client: IdentityClient): Promise<WasmTransactionInternalOutputVoid>;
  set gasBudget(value: bigint);
}
...
export class ConfigChangeProposal {
  private constructor();
  free(): void;
  approve(identity: OnChainIdentity): ApproveConfigChangeProposalTx;
  intoTx(identity: OnChainIdentity): ExecuteConfigChangeProposalTx;
  readonly id: string;
...
export class ControllerAndVotingPower {
  free(): void;
  constructor(address: string, voting_power: bigint);
  0: string;
  1: bigint;
}
/**
...
export class CreateConfigChangeProposalTx {
  private constructor();
  free(): void;
  withGasBudget(budget: bigint): CreateConfigChangeProposalTx;
  execute(client: IdentityClient): Promise<CreateConfigChangeProposalTxOutput>;
  set gasBudget(value: bigint);
}
...
*/
  toString(): string;
  free(): void;
  get output(): ConfigChangeProposal | undefined;
  set output(value: ConfigChangeProposal | null | undefined);
  response: WasmIotaTransactionBlockResponseWrapper;
}
export class CreateIdentityTx {
  private constructor();
  free(): void;
  withGasBudget(budget: bigint): CreateIdentityTx;
  execute(client: IdentityClient): Promise<TransactionOutputInternalOnChainIdentity>;
  set gasBudget(value: bigint);
}
export class CreateSendProposalTx {
  private constructor();
  free(): void;
  withGasBudget(budget: bigint): CreateSendProposalTx;
  execute(client: IdentityClient): Promise<CreateSendProposalTxOutput>;
  set gasBudget(value: bigint);
}
...
*/
  toString(): string;
  free(): void;
  get output(): SendProposal | undefined;
  set output(value: SendProposal | null | undefined);
  response: WasmIotaTransactionBlockResponseWrapper;
}
export class CreateUpdateDidProposalTx {
  private constructor();
  free(): void;
  withGasBudget(budget: bigint): CreateUpdateDidProposalTx;
  execute(client: IdentityClient): Promise<CreateUpdateDidProposalTxOutput>;
  set gasBudget(value: bigint);
}
...
*/
  toString(): string;
  free(): void;
  get output(): UpdateDidProposal | undefined;
  set output(value: UpdateDidProposal | null | undefined);
  response: WasmIotaTransactionBlockResponseWrapper;
}
/**
...
export class ExecuteConfigChangeProposalTx {
  private constructor();
  free(): void;
  withGasBudget(budget: bigint): ExecuteConfigChangeProposalTx;
  execute(client: IdentityClient): Promise<WasmTransactionInternalOutputVoid>;
  set gasBudget(value: bigint);
}
export class ExecuteSendProposalTx {
  private constructor();
  free(): void;
  withGasBudget(budget: bigint): ExecuteSendProposalTx;
  execute(client: IdentityClient): Promise<WasmTransactionInternalOutputVoid>;
  set gasBudget(value: bigint);
}
export class ExecuteUpdateDidProposalTx {
  private constructor();
  free(): void;
  withGasBudget(budget: bigint): ExecuteUpdateDidProposalTx;
  execute(client: IdentityClient): Promise<WasmTransactionInternalOutputVoid>;
  set gasBudget(value: bigint);
}
...
export class OnChainIdentity {
  ...
  isShared(): boolean;
  updateDidDocument(updated_doc: IotaDocument, expiration_epoch?: bigint | null): TransactionInternal<Proposal<UpdateDid> | ProposalOutput<UpdateDid>>;
  deactivateDid(expiration_epoch?: bigint | null): TransactionInternal<Proposal<UpdateDid> | ProposalOutput<UpdateDid>>;
  deleteDid(expiration_epoch?: bigint | null): TransactionInternal<Proposal<UpdateDid> | ProposalOutput<UpdateDid>>;
  updateConfig(config: ConfigChange, expiration_epoch?: bigint | null): TransactionInternal<Proposal<ConfigChange> | ProposalOutput<ConfigChange>>;
  sendAssets(transfer_map: ([string, string])[], expiration_epoch?: bigint | null): TransactionInternal<Proposal<SendAction> | ProposalOutput<SendAction>>;
}
...
export class PublishDidTx {
  private constructor();
  free(): void;
  withGasBudget(budget: bigint): PublishDidTx;
  execute(client: IdentityClient): Promise<TransactionOutputInternalIotaDocument>;
  set gasBudget(value: bigint);
}
/**
...
export class SendProposal {
  private constructor();
  free(): void;
  approve(identity: OnChainIdentity): ApproveSendProposalTx;
  intoTx(identity: OnChainIdentity): ExecuteSendProposalTx;
  readonly id: string;
...
export class TransactionOutputInternalOnChainIdentity {
  private constructor();
  free(): void;
  readonly output: OnChainIdentity;
  readonly response: WasmIotaTransactionBlockResponseWrapper;
}
...
export interface InitOutput {
  ...
  readonly controllerandvotingpower_new: (a: number, b: number, c: bigint) => number;
  ...
  readonly onchainidentity_updateDidDocument: (a: number, b: number, c: number, d: bigint) => number;
  readonly onchainidentity_deactivateDid: (a: number, b: number, c: bigint) => number;
  readonly onchainidentity_deleteDid: (a: number, b: number, c: bigint) => number;
  readonly onchainidentity_updateConfig: (a: number, b: number, c: number, d: bigint) => number;
  readonly onchainidentity_sendAssets: (a: number, b: number, c: number, d: number, e: bigint) => number;
  readonly onchainidentity_getHistory: (a: number, b: number, c: number, d: number) => any;
  readonly __wbg_identitybuilder_free: (a: number, b: number) => void;
  readonly identitybuilder_new: (a: number) => [number, number, number];
  readonly identitybuilder_controller: (a: number, b: number, c: number, d: bigint) => number;
  readonly identitybuilder_threshold: (a: number, b: bigint) => number;
  readonly identitybuilder_controllers: (a: number, b: number, c: number) => number;
  readonly identitybuilder_finish: (a: number) => number;
  readonly __wbg_createidentitytx_free: (a: number, b: number) => void;
  readonly createidentitytx_withGasBudget: (a: number, b: bigint) => number;
  readonly createidentitytx_set_gasBudget: (a: number, b: bigint) => void;
  readonly createidentitytx_execute: (a: number, b: number) => any;
  readonly __wbg_transactionoutputinternalonchainidentity_free: (a: number, b: number) => void;
  readonly transactionoutputinternalonchainidentity_output: (a: number) => number;
  readonly transactionoutputinternalonchainidentity_response: (a: number) => any;
  ...
  readonly configchangeproposal_approve: (a: number, b: number) => number;
  readonly configchangeproposal_intoTx: (a: number, b: number) => number;
  readonly __wbg_approveconfigchangeproposaltx_free: (a: number, b: number) => void;
  readonly approveconfigchangeproposaltx_withGasBudget: (a: number, b: bigint) => number;
  readonly approveconfigchangeproposaltx_set_gasBudget: (a: number, b: bigint) => void;
  readonly approveconfigchangeproposaltx_execute: (a: number, b: number) => any;
  readonly __wbg_executeconfigchangeproposaltx_free: (a: number, b: number) => void;
  readonly executeconfigchangeproposaltx_withGasBudget: (a: number, b: bigint) => number;
  readonly executeconfigchangeproposaltx_set_gasBudget: (a: number, b: bigint) => void;
  readonly executeconfigchangeproposaltx_execute: (a: number, b: number) => any;
  readonly __wbg_createconfigchangeproposaltxoutput_free: (a: number, b: number) => void;
  readonly __wbg_get_createconfigchangeproposaltxoutput_output: (a: number) => number;
  readonly __wbg_set_createconfigchangeproposaltxoutput_output: (a: number, b: number) => void;
  readonly __wbg_get_createconfigchangeproposaltxoutput_response: (a: number) => any;
  readonly __wbg_set_createconfigchangeproposaltxoutput_response: (a: number, b: any) => void;
  readonly __wbg_createconfigchangeproposaltx_free: (a: number, b: number) => void;
  readonly createconfigchangeproposaltx_withGasBudget: (a: number, b: bigint) => number;
  readonly createconfigchangeproposaltx_set_gasBudget: (a: number, b: bigint) => void;
  readonly createconfigchangeproposaltx_execute: (a: number, b: number) => any;
  ...
  readonly identityclientreadonly_migrationRegistryId: (a: number) => [number, number];
  ...
  readonly sendproposal_approve: (a: number, b: number) => number;
  readonly sendproposal_intoTx: (a: number, b: number) => number;
  readonly __wbg_approvesendproposaltx_free: (a: number, b: number) => void;
  readonly approvesendproposaltx_withGasBudget: (a: number, b: bigint) => number;
  readonly approvesendproposaltx_set_gasBudget: (a: number, b: bigint) => void;
  readonly approvesendproposaltx_execute: (a: number, b: number) => any;
  readonly __wbg_executesendproposaltx_free: (a: number, b: number) => void;
  readonly executesendproposaltx_withGasBudget: (a: number, b: bigint) => number;
  readonly executesendproposaltx_set_gasBudget: (a: number, b: bigint) => void;
  readonly executesendproposaltx_execute: (a: number, b: number) => any;
  readonly __wbg_createsendproposaltxoutput_free: (a: number, b: number) => void;
  readonly __wbg_get_createsendproposaltxoutput_output: (a: number) => number;
  readonly __wbg_set_createsendproposaltxoutput_output: (a: number, b: number) => void;
  readonly __wbg_get_createsendproposaltxoutput_response: (a: number) => any;
  readonly __wbg_set_createsendproposaltxoutput_response: (a: number, b: any) => void;
  readonly __wbg_createsendproposaltx_free: (a: number, b: number) => void;
  readonly createsendproposaltx_withGasBudget: (a: number, b: bigint) => number;
  readonly createsendproposaltx_set_gasBudget: (a: number, b: bigint) => void;
  readonly createsendproposaltx_execute: (a: number, b: number) => any;
  ...
  readonly __wbg_wasmtransactioninternaloutputvoid_free: (a: number, b: number) => void;
  readonly __wbg_get_wasmtransactioninternaloutputvoid_response: (a: number) => any;
  readonly __wbg_set_wasmtransactioninternaloutputvoid_response: (a: number, b: any) => void;
  ...
  readonly updateddidproposal_approve: (a: number, b: number) => number;
  readonly updateddidproposal_intoTx: (a: number, b: number) => number;
  readonly __wbg_approveupdatediddocumentproposaltx_free: (a: number, b: number) => void;
  readonly approveupdatediddocumentproposaltx_withGasBudget: (a: number, b: bigint) => number;
  readonly approveupdatediddocumentproposaltx_set_gasBudget: (a: number, b: bigint) => void;
  readonly approveupdatediddocumentproposaltx_execute: (a: number, b: number) => any;
  readonly __wbg_executeupdatedidproposaltx_free: (a: number, b: number) => void;
  readonly executeupdatedidproposaltx_withGasBudget: (a: number, b: bigint) => number;
  readonly executeupdatedidproposaltx_set_gasBudget: (a: number, b: bigint) => void;
  readonly executeupdatedidproposaltx_execute: (a: number, b: number) => any;
  readonly __wbg_createupdatedidproposaltxoutput_free: (a: number, b: number) => void;
  readonly __wbg_get_createupdatedidproposaltxoutput_output: (a: number) => number;
  readonly __wbg_set_createupdatedidproposaltxoutput_output: (a: number, b: number) => void;
  readonly __wbg_get_createupdatedidproposaltxoutput_response: (a: number) => any;
  readonly __wbg_set_createupdatedidproposaltxoutput_response: (a: number, b: any) => void;
  readonly __wbg_createupdatedidproposaltx_free: (a: number, b: number) => void;
  readonly createupdatedidproposaltx_withGasBudget: (a: number, b: bigint) => number;
  readonly createupdatedidproposaltx_set_gasBudget: (a: number, b: bigint) => void;
  readonly createupdatedidproposaltx_execute: (a: number, b: number) => any;
  ...
  readonly identityclient_migrationRegistryId: (a: number) => [number, number];
  ...
  readonly identityclient_publishDidDocument: (a: number, b: number) => [number, number, number];
  ...
  readonly __wbg_publishdidtx_free: (a: number, b: number) => void;
  readonly publishdidtx_withGasBudget: (a: number, b: bigint) => number;
  readonly publishdidtx_set_gasBudget: (a: number, b: bigint) => void;
  readonly publishdidtx_execute: (a: number, b: number) => any;
  ...
  readonly closure3702_externref_shim: (a: number, b: number, c: any) => void;
  readonly closure3839_externref_shim: (a: number, b: number, c: any, d: any) => void;
