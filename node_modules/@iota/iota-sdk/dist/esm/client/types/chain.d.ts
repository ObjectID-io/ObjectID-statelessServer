import type { AddressMetrics, Checkpoint, DynamicFieldInfo, EpochInfo, EpochMetrics, IotaCallArg, IotaMoveNormalizedModule, IotaParsedData, IotaTransaction } from './generated.js';
...
export type IotaMoveObject = Extract<IotaParsedData, {
    dataType: 'moveObject';
}>;
export type IotaMovePackage = Extract<IotaParsedData, {
    dataType: 'package';
}>;
