...
export type IotaArgument = 'GasCoin' /** One of the input objects or primitive values (from `ProgrammableTransactionBlock` inputs) */ | {
    Input: number;
...
export type IotaEndOfEpochTransactionKind = 'AuthenticatorStateCreate' | {
...
export type IotaMoveNormalizedType = 'Bool' | 'U8' | 'U16' | 'U32' | 'U64' | 'U128' | 'U256' | 'Address' | 'Signer' | {
    Struct: {
        address: string;
        module: string;
        name: string;
 ...
 */
export type IotaTransactionKind = 'ProgrammableTransaction' | 'Genesis' | 'ConsensusCommitPrologueV1' | 'AuthenticatorStateUpdateV1' | 'RandomnessStateUpdate' | 'EndOfEpochTransaction' | 'SystemTransaction';
/**
...
export type IotaMoveFunctionArgType = 'Pure' | {
