...
export default async function remove_approver_did(req: Request, res: Response) {
  try {
    const { seed, network, controllerCap, document, approver_did } = req.body;

    logInputs("remove_approver_did", {
      network,
      controllerCap,
      document,
      approver_did,
    ...
    const moveFunction = documentPackageID + "::oid_document::remove_approver_did";
